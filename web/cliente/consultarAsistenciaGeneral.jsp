<%-- 
    Document   : consultarAsistenciaGeneral
    Created on : 24/11/2024, 10:11:52 a. m.
    Author     : Pc
--%>
...
<%@page import="DatabaseConnection.ModeloAsistenciaGeneral"%>
...
<html>
    ...
    <title>Corpusfit - Consulta de Asistencia General</title>

    <body oncontextmenu='return false' class='snippet-body'>
        <div class="container-contact100">
            <div class="wrap-contact100">
                <form class="contact100-form validate-form" action="../ConsultarAsistenciaGeneralServlet" method="post" id="formulario">
                    <span class="contact100-form-title">
                        Consulta de Asistencia General
                    </span>
                ...
                <!-- Tabla de resultados -->
                <%
                    List<ModeloAsistenciaGeneral> asistencias = (List<ModeloAsistenciaGeneral>) session.getAttribute("asistencias");
                ...
                <div class="tabla-asistencias">
                    <table>
                        ...
                        <tbody>
                            <%
                                for (ModeloAsistenciaGeneral asistencia : asistencias) {
                            %>
                            <tr>
                                <td><%= asistencia.getId_asistencia()%></td>
                                <td><%= asistencia.getFecha_asistencia()%></td>
                                <td><%= asistencia.getHora_entrada()%></td>
                                <td><%= asistencia.getHora_salida()%></td>
                            </tr>
                            <%
                                }
                            %>
